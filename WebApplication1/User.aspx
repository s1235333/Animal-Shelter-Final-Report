...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated">
            <Columns>
    ...
    <div style="width:100px; padding-left:250px; padding-top:25px;">
        <asp:Button ID="Button1" runat="server" Text="新增" CssClass="btn-group" OnClick="Button1_Click" />
    </div>
